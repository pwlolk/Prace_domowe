...
wzor_descr = "Posłużymy się następującym wzorem [°F]=[°C]*1.8+32"
print("")
print(intro.upper())
print(wzor_descr)
print("")
...
print("Temperatura w skali Fahrenheita: " + str(temp_F) + "°F")
print("Temperatura w skali Fahrenheita, z dokładnością do drugiego miejsca po przecinku: " + str(temp_F_2) + "°F")
print("")
